...
from daily_quests.views import get_quest_progress, update_quest_progress  # ✅ ИМПОРТ РАБОТАЕТ
...
urlpatterns = [
    ...
    path('api/daily-quests/update/', update_quest_progress, name='daily-quests-update'),
]